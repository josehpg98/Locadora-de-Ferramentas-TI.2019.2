 ...
 */
public class Formequipamento extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t  FROM Tblequipamento t");
        ...
        equCodigoField = new javax.swing.JTextField();
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${equCodigo}"));
        ...
        columnBinding.setColumnName("Valor (Semanal)");
        ...
        equCodigoField.setEditable(false);

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.equCodigo}"), equCodigoField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), equCodigoField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(equCodigoLabel)
                    .addComponent(equCodigoField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nomeLabel)
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == btnsalvar) {
                Formequipamento.this.btnsalvarActionPerformed(evt);
            }
            else if (evt.getSource() == btnatualizar) {
                Formequipamento.this.btnatualizarActionPerformed(evt);
            }
            else if (evt.getSource() == btnovo) {
                Formequipamento.this.btnovoActionPerformed(evt);
            }
            else if (evt.getSource() == btnremover) {
                Formequipamento.this.btnremoverActionPerformed(evt);
            }
        }
    ...
    private void btnremoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoverActionPerformed
        ...
        List<br.edu.ifsul.classes.Tblequipamento> toRemove = new ArrayList<br.edu.ifsul.classes.Tblequipamento>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.edu.ifsul.classes.Tblequipamento t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void btnovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnovoActionPerformed
        br.edu.ifsul.classes.Tblequipamento t = new br.edu.ifsul.classes.Tblequipamento();
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        if (nomeField.getText().length() <= 0 || nomeField.getText().length() > 50) {
            JOptionPane.showMessageDialog(null, " Verifique o campo nome!");
            nomeField.requestFocus();
            validar = false;
            return;
        }
        if (marcaField.getText().length() <= 0 || marcaField.getText().length() > 30) {
            JOptionPane.showMessageDialog(null, " Verifique o campo marca do equipamento!");
            marcaField.requestFocus();
            validar = false;
            return;
        }
        if (valorField.getText().length() <= 0) {
            JOptionPane.showMessageDialog(null, " Verifique o campo valor do equipamento!");
            valorField.requestFocus();
            validar = false;
            return;
        }
        if (estoqueField.getText().length() <= 0) {
            JOptionPane.showMessageDialog(null, "verifique o campo de estoque do equipamento!");
        ...
        if (validar) {
            try {
                ...
                //rex.printStackTrace();
                JOptionPane.showMessageDialog(null, "O equipamento nao pode ser excluido, pois já é referênciado na tabela de item locado em uma locação!");
                entityManager.getTransaction().begin();
                List<br.edu.ifsul.classes.Tblequipamento> merged = new ArrayList<br.edu.ifsul.classes.Tblequipamento>(list.size());
                for (br.edu.ifsul.classes.Tblequipamento t : list) {
    ...
    private javax.swing.JTextField equCodigoField;
    ...
    private java.util.List<br.edu.ifsul.classes.Tblequipamento> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame frame = new JFrame("Equipamentos");
                frame.setContentPane(new Formequipamento());
