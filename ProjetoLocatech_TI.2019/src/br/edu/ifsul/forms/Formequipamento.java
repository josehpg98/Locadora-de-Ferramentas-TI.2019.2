...
public class Formequipamento extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnName("Cód. Equipamento");
        ...
        equCodigoLabel.setText("Cód. Equipamento:");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(equCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)
                                    .addComponent(nomeField, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)
                                    .addComponent(marcaField, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)
                                    .addComponent(valorField, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)))
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Formequipamento.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Formequipamento.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Formequipamento.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Formequipamento.this.deleteButtonActionPerformed(evt);
            }
        }
