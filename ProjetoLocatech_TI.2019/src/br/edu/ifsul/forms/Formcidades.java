...
public class Formcidades extends JPanel {
    ...
    private void initComponents() {
        ...
        masterTable.setSelectionBackground(new java.awt.Color(0, 102, 0));
        ...
        cidCodigoLabel.setText(" Cód. Cidade:");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cidCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
                                    .addComponent(nomeField, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
                                    .addComponent(ufField, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)))
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Formcidades.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Formcidades.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Formcidades.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Formcidades.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (nomeField.getText().length() <= 0) {
            JOptionPane.showMessageDialog(null, "O nome da cidade deve ser informado!");
            nomeField.requestFocus();//o ponteiro do mose ficará pscando na field do nome
            valid = false;
            return;
        }
        if (ufField.getText().length() <= 0) {
            JOptionPane.showMessageDialog(null, "A unidade federativa da cidade deve ser informada!");
            ufField.requestFocus();//o ponteiro do mose ficará pscando na field do nome
            valid = false;
            return;
        }
        if (valid) {
