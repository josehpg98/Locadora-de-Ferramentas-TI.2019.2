...
public class Testelistalocacao {
    ...
    public static void main(String[] args) {
        ...
        for(Tbllocacao l : loc){
            System.out.println(" Codogo da Locação: "+l.getLocCodigo()+" Funcionário: "+l.getFunCodigo()+" Cliente: "+l.getCliCodigo()+" Data da Locação:"+l.getDataLoc()+" Valor Total: "+l.getValorTotal());
        }
    }
